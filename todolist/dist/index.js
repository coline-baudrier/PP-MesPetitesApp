...
function listTasks() {
    ...
    if (tasks.length === 0) {
        ...
        tasks.forEach(function (task, index) {
            console.log("".concat(index + 1, ". [").concat(task.done ? "x" : " ", "] ").concat(task.text));
        });
    }
}
// Ajouter une tâche
                    ...
                    return [4 /*yield*/, inquirer_1.default.prompt([
                            {
                                ...
                                choices: tasks.map(function (task, i) { return ({
                                    name: "".concat(task.done ? "[x]" : "[ ]", " ").concat(task.text),
                                    value: i,
                                }); }),
                            },
                        ])];
